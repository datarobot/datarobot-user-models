...
`drum fit --code-dir task_templates/3_pipelines/2_python3_sklearn_regression --input tests/testdata/juniors_3_year_stats_regression.csv --target-type regression --target "Grade 2014"`
