...
`drum fit --code-dir task_templates/3_pipelines/8python3_calibrated_anomaly_detection --input tests/testdata/juniors_3_year_stats_regression.csv --target-type anomaly`
