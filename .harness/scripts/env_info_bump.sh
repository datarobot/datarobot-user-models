...
declare -a ENVS
ENVS=(
  public_dropin_environments/java_codegen
  public_dropin_environments/python311
  public_dropin_environments/python311_genai_agents
  public_dropin_environments/python3_keras
  public_dropin_environments/python3_onnx
  public_dropin_environments/python3_pytorch
  public_dropin_environments/python3_sklearn
  public_dropin_environments/python3_xgboost
  public_dropin_environments/r_lang
)
