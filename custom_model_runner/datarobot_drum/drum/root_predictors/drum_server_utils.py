...
class DrumServerRun:
    ...
    def __init__(
        ...
        self._multi_container_deployment = multi_container_deployment
    ...
    def get_command(self):
        ...
        if self._multi_container_deployment:
            cmd += "  --multi-container-deployment {}".format(self._multi_container_deployment)
