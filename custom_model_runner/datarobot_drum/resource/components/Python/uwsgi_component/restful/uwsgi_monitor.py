...
from datarobot_drum.resource.components.Python.uwsgi_component.common.buff_to_lines import (
    BufferToLines,
)
...
from datarobot_drum.resource.components.Python.uwsgi_component.restful.uwsgi_statistics import (
    UwsgiStatistics,
)
            ...
            while keep_reading:
                ...
                if readable_fd:
                    ...
                    if stop_msg and stop_msg.encode() in buff:
                        keep_reading = False
        except UwsgiNginxCoreException:
            if self._logging_udp_socket:
                self._logging_udp_socket.close()
            raise
