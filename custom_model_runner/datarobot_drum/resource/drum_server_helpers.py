...
from datarobot_drum.drum.common import ArgumentsOptions, TargetType
...
def _cmd_add_class_labels(cmd, labels, target_type, multiclass_label_file=None):
    if not labels or target_type == TargetType.BINARY.value:
    ...
    elif labels and target_type == TargetType.MULTICLASS.value:
