...
_artifacts = {
    ...
    (ONNX, REGRESSION): os.path.join(TESTS_ARTIFACTS_PATH, "onnx_reg.onnx"),
    (ONNX, BINARY): os.path.join(TESTS_ARTIFACTS_PATH, "onnx_bin.onnx"),
    (ONNX, MULTICLASS): os.path.join(TESTS_ARTIFACTS_PATH, "onnx_multi.onnx"),
    (ONNX, MULTICLASS_BINARY): os.path.join(TESTS_ARTIFACTS_PATH, "onnx_bin.onnx"),
