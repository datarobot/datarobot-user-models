...
R_TRANSFORM_DENSE = "R_transform_dense"
R_TRANSFORM_WITH_Y = "R_transform_with_y"
R_TRANSFORM_NO_Y = "R_transform_no_y"
R_TRANSFORM_NO_Y_DENSE = "R_transform_no_y_dense"
