...
TRANSFORM_TEMPLATES_PATH = os.path.join(REPO_ROOT_PATH, "task_templates", "1_transforms")
ESTIMATORS_TEMPLATES_PATH = os.path.join(REPO_ROOT_PATH, "task_templates", "2_estimators")
TRAINING_TEMPLATES_PATH = os.path.join(REPO_ROOT_PATH, "task_templates", "3_pipelines")
...
PYTHON311_GENAI = "python311_genai"
...
GPU_TRITON = "triton"
GPU_NIM = "nim"
GPU_NIM_MULTI_CONTAINER = "nim_multi_container"
GPU_NIM_EMBEDQA = "nim_embedqa"
GPU_VLLM = "vllm"
PYTHON_TEXT_GENERATION = "python_text_generation"
PYTHON_GEO_POINT = "python_geo_point"
