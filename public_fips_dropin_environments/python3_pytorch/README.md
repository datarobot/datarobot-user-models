# Python 3 PyTorch FIPS-compliant Drop-In Template Environment
...
1. From the terminal, run `tar -czvf py_dropin.tar.gz -C /path/to/public_fips_dropin_environments/python3_pytorch/ .`
