...
def deserialize_estimator_pipeline(joblib_dir_path: str) -> Pipeline:
    """
    ...
    ----------
    joblib_dir_path: str
        The directory path of joblib file to load from.
    ...
    joblib_file_path = Path(joblib_dir_path) / "artifact.joblib"
