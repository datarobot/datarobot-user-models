...
public class CustomModelReturnTypeTest {
 ...
 public void checkCustomModelReturn() {
   ...
   assertTrue(cmBinary.predictUnstructured(r, mimetype, charset, queryBinary) instanceof byte[]);
   assertTrue(cmString.predictUnstructured(r, mimetype, charset, queryString) instanceof String);
}
