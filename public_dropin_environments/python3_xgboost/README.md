...
If these assumptions are incorrect for your model, you should make a copy of [custom.py](https://github.com/datarobot/datarobot-user-models/blob/master/model_templates/python3_xgboost/custom.py), modify it as needed, and include in your custom model archive.
