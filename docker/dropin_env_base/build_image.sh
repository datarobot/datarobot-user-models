...
IMAGE_NAME_DATAROBOTDEV=datarobotdev/dropin-env-base
IMAGE_NAME_DATAROBOT=datarobot/dropin-env-base
IMAGE_TAG=debian11-py3.9-jre11.0.16-drum1.11.5-mlops9.2.8
...
#docker build --build-arg DATAROBOT_MLOPS_VERSION=${DATAROBOT_MLOPS_VERSION} -t ${IMAGE_NAME_DATAROBOTDEV}:${IMAGE_TAG} .
